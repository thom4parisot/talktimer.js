...
Talktimer.prototype.bindTimerEvents = function(){
  ...
  this.timer.on('reset', this.drawer.reset.bind(this));
  this.timer.on('init', this.drawer.end.bind(this));
  this.timer.on('stop', this.drawer.end.bind(this));
